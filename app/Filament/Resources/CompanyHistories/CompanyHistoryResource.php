...
class CompanyHistoryResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema  { return CompanyHistoryForm::configure($schema); }
    public static function table(Table $table): Table    { return CompanyHistoriesTable::configure($table); }

...
class CertificationResource extends Resource
{
    ...
    public static function getNavigationLabel(): string  { return __('Certifications'); }
    public static function getModelLabel(): string       { return __('Certification'); }
    public static function getPluralModelLabel(): string { return __('Certifications'); }

    public static function form(Schema $schema): Schema  { return CertificationForm::configure($schema); }
    public static function table(Table $table): Table    { return CertificationsTable::configure($table); }

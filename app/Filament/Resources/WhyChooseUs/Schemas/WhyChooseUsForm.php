...
class WhyChooseUsForm
{
    public static function configure(Schema $schema): Schema
    {
        ...
        return $schema
            ->components([
                Tabs::make('Why Choose Us Content')
                    ->tabs([
                        // ─── Tab 1: Section Content (main title & short desc) ─────
                        Tabs\Tab::make(__('Section Content'))
                        ...
                        // ─── Tab 2: Advantages / Items (repeater with nested tabs) ──
                        Tabs\Tab::make(__('Advantages / Reasons'))
                        ...
                        Tabs\Tab::make(__('Display & Status'))

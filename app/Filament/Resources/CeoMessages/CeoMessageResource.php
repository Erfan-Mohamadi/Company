...
class CeoMessageResource extends Resource
{
    ...
    public static function getNavigationGroup(): ?string { return __('Our Team'); }
    public static function getNavigationLabel(): string  { return __("CEO's Message"); }
    public static function getModelLabel(): string       { return __("CEO Message"); }
    public static function getPluralModelLabel(): string { return __("CEO Messages"); }

    public static function form(Schema $schema): Schema { return CeoMessageForm::configure($schema); }
    public static function table(Table $table): Table   { return CeoMessagesTable::configure($table); }

...
class CoreValueResource extends Resource
{
    ...
    protected static string|null|\BackedEnum $navigationIcon = Heroicon::Heart;   // ← Fixed

    protected static string|null|\UnitEnum $navigationGroup = 'Company Profile';

    protected static ?int $navigationSort = 4;   // after About and Mission/Vision

    protected static ?string $recordTitleAttribute = 'value_name';   // ← Fixed (use translatable field)
    ...
    {
        return __('Core Values');
    }

    public static function getModelLabel(): string
    {
        return __('Core Value');
    }
